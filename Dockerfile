...
RUN curl -SL http://apache.mirrors.pair.com/maven/maven-3/3.1.1/binaries/apache-maven-3.1.1-bin.tar.gz | tar -xvC /usr/local
ADD apache-maven-3.1.1-bin.tar.gz /usr/local
